        ...
        <AdminLayout>
            <div className="max-w-6xl mx-auto selection:bg-accent/10">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 px-2">
                    <div>
                        <h1 className="text-4xl font-bold text-[hsl(var(--admin-text))] tracking-tight font-display mb-2">Library</h1>
                        <p className="text-[hsl(var(--admin-text-dim))] text-sm">Documents and downloads — bulletins, forms, Bible studies, and more.</p>
                    </div>
                    <button
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-8">
                                                ...
                                                ${dragOver
                                                    ...
                                                    : uploading
                                                        ...
                                                        : form.fileUrl
                                                            ...
                                                            : 'border-[hsl(var(--admin-border))] hover:border-accent/50 hover:bg-accent/5'
                                                }`}
                                        >
                                            {uploading ? (
                                                <>
                                                    ...
                                                    />
                                                    <p className="text-accent text-[11px] font-bold tracking-widest uppercase">{uploadProgress}</p>
                                                    <div className="mt-2 w-3/4 h-1.5 bg-accent/10 rounded-full overflow-hidden">
                                                        <motion.div
                                                ...
                                                <>
                                                    <div className="w-10 h-10 rounded-2xl bg-accent/10 border border-accent/20 flex items-center justify-center text-accent text-lg">✓</div>
                                                    <div className="text-center px-4">
                                                        <p className="text-accent text-[11px] font-bold tracking-wider mb-1">File Uploaded</p>
                                                ...
                                                <>
                                                    ...
                                                    <div className="text-center">
                                                        <p className="text-[hsl(var(--admin-text-dim))]/60 text-[11px] font-bold">Drop file here or <span className="text-accent">click to browse</span></p>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-[hsl(var(--admin-text))]/5 border border-[hsl(var(--admin-border))] rounded-2xl px-6 py-4 text-[hsl(var(--admin-text))] text-sm placeholder:text-[hsl(var(--admin-text-dim))]/30 focus:ring-4 focus:ring-accent/5 focus:border-accent/40 outline-none transition-all duration-300"
                                        />
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full bg-[hsl(var(--admin-text))]/5 border border-[hsl(var(--admin-border))] rounded-2xl px-6 py-4 text-[hsl(var(--admin-text))] text-sm focus:ring-4 focus:ring-accent/5 focus:border-accent/40 outline-none transition-all duration-300 appearance-none"
                                            >
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            className="w-full bg-[hsl(var(--admin-text))]/5 border border-[hsl(var(--admin-border))] rounded-[2rem] px-6 py-5 text-[hsl(var(--admin-text))] text-sm placeholder:text-[hsl(var(--admin-text-dim))]/30 focus:ring-4 focus:ring-accent/5 focus:border-accent/40 outline-none transition-all duration-300 resize-none"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 mt-10 pt-10 border-t border-[hsl(var(--admin-border))]">
                                    ...
                                    <button
                                        onClick={handleSave}
                                        disabled={uploading}
                                        className="flex-1 h-16 bg-accent text-white text-[11px] font-bold tracking-widest uppercase rounded-[1.5rem] hover:shadow-2xl hover:shadow-accent/40 transition-all hover:scale-105 active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed"
                                    >
                        ...
                        <AnimatePresence mode="popLayout">
                            {resources.map((r) => (
                                <motion.div
                                    ...
                                    className="group bg-[hsl(var(--admin-surface))] rounded-[2rem] p-8 border border-[hsl(var(--admin-border))] hover:border-accent/40 hover:shadow-xl transition-all duration-500 relative flex flex-col justify-between"
                                >
                                    <div>
                                        <div className="flex items-start justify-between mb-6">
                                            <div className="px-3 py-1 rounded-lg bg-accent/10 text-accent text-[9px] font-bold uppercase tracking-widest border border-accent/20">
                                                {r.category}
                                            </div>
                                            <div className="flex gap-2">
                                                <button onClick={() => handleEdit(r)} aria-label="Edit resource" className="w-9 h-9 flex items-center justify-center bg-[hsl(var(--admin-text))]/5 rounded-lg text-[hsl(var(--admin-text))]/60 hover:text-accent hover:bg-accent/10 transition-colors">
                                                ...
                                                <button onClick={() => handleDelete(r.id)} aria-label="Delete resource" className="w-9 h-9 flex items-center justify-center bg-[hsl(var(--admin-text))]/5 rounded-lg text-[hsl(var(--admin-text))]/60 hover:text-coral hover:bg-coral/10 transition-colors">
                                        ...
                                        <h3 className="text-lg font-bold text-[hsl(var(--admin-text))] mb-2 font-display leading-tight group-hover:text-accent transition-colors">{r.title}</h3>
                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-[hsl(var(--admin-border))]">
                                        ...
                                        <a href={r.file_url || r.fileUrl} target="_blank" rel="noopener noreferrer" className="text-[9px] font-bold text-accent uppercase tracking-widest hover:underline">
                                            Open File →
                                        </a>
                                    </div>
                                </motion.div>
